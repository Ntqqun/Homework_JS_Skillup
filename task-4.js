...
let credits = 23580
let droid_price = 3000

input = prompt("К-сть дроїдів")

if (input == null) {
    console.log('Скасовано користувачем!')
} else {
    let totalPrice = input * droid_price
    if (totalPrice > credits) {
        console.log('Недостатньо коштів на рахунку!')
    } else {
        let zalushok = credits - totalPrice;
        console.log(`Ви купили ${input} дроїдів, на рахунку залишилося ${zalushok} кредитів.`)
    }
}